...
class BookRepositoryImpl
    ...
    constructor(
        ...
        override suspend fun getBookInfo(isbn: String): BookInfoEntity? = bookDao.findBookByIsbn(isbn)
        ...
        override fun getAllBooks(): Flow<List<BookInfoEntity>> = bookDao.getAllBooks()

        override suspend fun getBookInfoFromApi(query: String): Response<BookResponse> = bookApiService.getBookInfo(query)
    }
